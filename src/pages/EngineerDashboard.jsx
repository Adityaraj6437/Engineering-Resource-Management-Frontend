    ...
    const loadData = async () => {
      try {
        const [assignmentsRes, capacityRes] = await Promise.all([
          axios.get("https://engineering-resource-management-backend-2.onrender.com/api/assignments", {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get(`https://engineering-resource-management-backend-2.onrender.com/api/engineers/engineer/capacity/${user._id}`, {
            headers: { Authorization: `Bearer ${token}` },
          }),
        ]);
